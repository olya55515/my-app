...
import { CartItem, addItem, minusItem, removeItems } from '../redux/slices/cartSlice';
...
const onClickRemove = () => {
  if (window.confirm('Ви точно хотите удалить товар из корзины😞?')) {
    dispatch(removeItems(String(id)))
  }
};
